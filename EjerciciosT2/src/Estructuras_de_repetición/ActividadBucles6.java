...
public class ActividadBucles6 {
	public static void main(String args[]) {
		...
		System.out.println("Codigo de la pelicula mas alquilada: "
				+ cod_alquilada1);

		System.out.println("Codigo de la segunda pelicula mas alquilada: "
				+ cod_alquilada2);

		System.out.println("Codigo de la pelicula menos alquilada: "
				+ cod_menos_alquilada);

		porcentaje_20 = 100 * (alquiladas_mas_de_veinte / (double) cont);
		System.out
				.println("Porcentaje de peliculas alquiladas mas de 20 veces: "
						+ porcentaje_20);

		porcentaje_5 = 100 * (alquilada_menos_de_cinco / (double) cont);
		System.out
				.println("Porcentaje de peliculas alquiladas menos de 5 veces: "
						+ porcentaje_5);

		porcentaje_715 = 100 * (entre_siete_y_quince / (double) cont);
		System.out
				.println("Porcentaje de peliculas alquiladas entre 7 y 15 veces: "
						+ porcentaje_715);

		System.out
				.println("Media del numero de veces que se alquila cada pelicula: "
						+ suma_alquilada / cont);
